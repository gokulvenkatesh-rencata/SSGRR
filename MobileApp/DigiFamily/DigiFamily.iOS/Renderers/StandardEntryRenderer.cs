...
using CoreGraphics;
using Foundation;
using DigiFamily.iOS.Renderers;
...
namespace DigiFamily.iOS.Renderers
{
    ...
    public class StandardEntryRenderer : EntryRenderer
    {
        ...
        {
            UITextFieldPadding control = new UITextFieldPadding(RectangleF.Empty)
            {
    ...
    public class UITextFieldPadding : UITextField
    {
        ...
        {
            UIEdgeInsets insets = new UIEdgeInsets((float)Padding.Top, (float)Padding.Left, (float)Padding.Bottom, (float)Padding.Right);
